    ...
    if($data["total"] == 1) {
        ...
        if($new["alttext"] == "") {
            ...
            if($new["promo"] != 1) {
                ...
                // // mediametrics
                // $text .= "<div style='height:30px;'><style>.comments{margin-top:-10px;}</style></div><script src='//mediametrics.ru/partner/inject/injectv2.js' type='text/javascript' id='MediaMetricsInject' data-adaptive='true' data-img='true' data-imgsize='90' data-type='img-rect' data-bgcolor='FFFFFF' data-bordercolor='000000' data-linkscolor='232323' data-transparent='true' data-rows='5' data-inline='' data-fontfamily='Open+Sans' data-border='' data-borderwidth='0' data-place='left' data-fontsize='14' data-lineheight=21 data-visiblerows=3 data-fontweight=100 data-fontalign=left data-textposition=\"bottom\" data-fontfamilycurrent=\"Open Sans\" data-period='online' data-alignment='vertical' data-country='ru' data-site='mmet///progorodchelny_ru'> </script>";
                    //smi2
...
*/
    ### Основной запрос
                ...
                if( empty($item["uid"]) || empty($item["nick"]) ) {
                    ...
                    $noauthor = '<span class="article-info__author">Автор: progorodchelny.ru</span>';
                } else {
