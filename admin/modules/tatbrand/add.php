...
// СОХРАНЕНИЕ ПОЛЕЙ И ФОРМ
	...
	if (isset($P["savebutton"])) {
		...
		$q="INSERT INTO `".$alias."_lenta` (`uid`, `domain`, `name`, `kw`, `ds`, `cens`, `realinfo`, `comments`, `data`, `astat`, `adata`, `votingend`, `promo`, `onind`, `spec`, `yarss`, `mailrss`, `tavto`, `tags`, `redak`,`gis`,`galka`)
		VALUES ('".$_SESSION['userid']."', '".(int)$P["domain"]."', '".$P["dname"]."', '".$P["dkw"]."', '".$P["dds"]."', '".$P["cens"]."', '".$P["realinfo"]."', '".$P["comms"]."', '".$sdata1."',
